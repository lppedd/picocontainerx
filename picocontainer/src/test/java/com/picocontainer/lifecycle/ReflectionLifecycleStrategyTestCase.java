		...
		mockery.checking(new Expectations() {
			{
				...
				one(monitor).invoked(with(aNull(PicoContainer.class)),
                        ...
                        with(any(Long.class)), with((org.hamcrest.Matcher<Boolean>) (Object) same(null)), with(any(Object[].class)));
			...
			mockery.checking(new Expectations() {
				{
					...
					one(monitor).invoked(
							with(aNull(PicoContainer.class)),
							with(aNull(ComponentAdapter.class)),
							with(isStopMethod), with(same(mock)), with(any(Long.class)), with((org.hamcrest.Matcher<Boolean>) (Object) same(null)), with(any(Object[].class)));
				}
			});
			return mock;
		}
