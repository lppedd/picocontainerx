...
public class Issue0265TestCase {
    ...
    public @Test void testCanReallyChangeMonitor() throws SecurityException, NoSuchMethodException {
        ...
        mockery.checking(new Expectations() {{
            ...
            one(monitor1).invoked(with(any(PicoContainer.class)), with(any(ComponentAdapter.class)), with(equal(start)),
            		with(any(Object.class)), with(any(Long.class)), with((org.hamcrest.Matcher<Boolean>) (Object) same(null)), with(any(Object[].class)));
